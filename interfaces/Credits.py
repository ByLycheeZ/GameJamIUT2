    ...
    def affichage(self, ecran):
        if self.montrer:
            ...
            if self.equipe and not self.sources:
                ...
                ecran.blit(font.render("Logo CarryBoo", True, self.NOM), (self.NOM_X, 300))
                ecran.blit(font.render("Flèche démarrage", True, self.NOM), (self.NOM_X, 330))

                ecran.blit(font.render("Musique", True, self.NOM), (self.NOM_X, 370))
                ecran.blit(font.render("Musique alternative", True, self.NOM), (self.NOM_X, 400))
                ecran.blit(font.render("Son de tornade", True, self.NOM), (self.NOM_X, 450))
                ...
                ecran.blit(font.render("Son de saut", True, self.NOM), (self.NOM_X, 600))
                ecran.blit(font.render("Son de vent", True, self.NOM), (self.NOM_X, 630))
                ecran.blit(font.render("Son de bouton", True, self.NOM), (self.NOM_X, 660))
                ecran.blit(font.render("Son logo CarryBoo", True, self.NOM), (self.NOM_X, 690))
                ...
                ecran.blit(font.render("https://www.vecteezy.com/vector-art/153284-free-caribou-vector-collection", True, self.DESCRIPTION), (self.DESC_X, 303))
                ecran.blit(font.render("https://pixabay.com/fr/vectors/droit-arrow-formes-pointage-29247", True, self.DESCRIPTION), (self.DESC_X, 333))

                ecran.blit(font.render("https://www.fesliyanstudios.com/royalty-free-music/download/retro-platforming/454", True, self.DESCRIPTION), (self.DESC_X, 373))
                ecran.blit(font.render("https://freemusicarchive.org/music/sawsquarenoise/Towel_Defence_OST/", True, self.DESCRIPTION), (self.DESC_X, 403))
                ecran.blit(font.render("Towel_Defence_Ingame", True, self.DESCRIPTION), (self.DESC_X, 420))
                ...
                ecran.blit(font.render("https://opengameart.org/content/platformer-jumping-sounds", True, self.DESCRIPTION), (self.DESC_X, 603))
                ecran.blit(font.render("https://freesound.org/people/qubodup/sounds/60009/", True, self.DESCRIPTION), (self.DESC_X, 633))
                ecran.blit(font.render("https://freesound.org/people/volkbutphan/sounds/485486/", True, self.DESCRIPTION), (self.DESC_X, 663))
                ecran.blit(font.render("https://freesound.org/people/luminousfridge/sounds/496199/", True, self.DESCRIPTION), (self.DESC_X, 693))
